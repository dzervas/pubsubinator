...
use nrf_softdevice::ble::{gatt_server, peripheral, MasterId, EncryptionInfo, IdentityKey};
...
pub struct KeyboardService {
	...
	report_map: [u8; 45], // This will be an array that describes the report format.
